...
// Access Specifiers:
// Public -->  to access member or data anywhere in program
// Private --> Private members are accessible in only its class 
// Protected --> Protected members can be used in other class also as protected mode
